...
This research focuses on graduate students enrolled at a mid-size university in the Rocky Mountains, where Methods of Data Analysis I and II are graduate statistics courses required for the completion of a Master's degree in many Environmental Science fields, such as Ecology, Land Resources Environmental Sciences, Animal and Range Sciences, Plant Sciences. The large assortment of fields this sequence of courses services will hence be labeled under the banner of  Environmental Science. This terminal statistics sequence intends to prepare graduate students for the statistical and computational problems they may face as researchers and practitioners. The intention of this study was to describe and understand what factors impact Environmental Science graduate students' computational knowledge and ability to reason through applications in their disciplines. In examining the experiences Environmental Science graduate students face when applying their computational skills, the present study seeks to capture a more in-depth understanding of the successes and shortfalls experienced when implementing computational thinking and skills. 

Students who participated in the study both described their experiences with computational thinking and reasoning through applications related to their field. The primary research questions that guided this study were:  

1. What factors (attitude, background, course content, etc.) impact graduate Environmental Science students' ability to transfer computational skills and understandings to applications in their discipline?  
...
For this study we focus on the factors that impact Environmental Science graduate students' computational knowledge and ability to reason through applications in their disciplines. Unlike typical definitions of computational knowledge and abilities, which focus on a student's understanding and fluency of computer program, we chose to also include knowledge of data structures, the ability to reason through problems with a given set of tools, as well as knowledge of resources that could provide assistance in solving a particular problem \cite{compthinking}. 

<!-- In a similar approach to Weintrop, et al. we move away from defining computational knowledge and abilities to decontextualized computer science specific practices, instead focusing on "real-world instantiations of computational thinking in the wild." -->
...
r <- ggplot(prereq, aes(x = Prereq, y = count, colour = Prereq, 
  ...
  labs(list(title = "Survey Participant \nMethods of Data Analysis I Enrollment", x = "", 
...
\end{tikzpicture} 
\caption{\label{Figure 1} Computational Knowledge Acquisition Concept Map}
\end{figure}
\end{center}
...
\bibitem{hildreth}
Hildreth, L. (2016). Methods of Data Analysis I [Syllabus]. Montana State University, Department of Mathematics and Statistics.
