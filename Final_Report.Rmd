...
# Computational Needs and Abilities of Envrionmental Science Students
...
\tikzstyle{every node}=[minimum width = 100pt, align = center]

\pgfmathsetmacro{\shift}{0.25ex}

\node [draw, ellipse,  text width = 2cm, align = center] (1) at (-8, 4) {Background};
\node [draw , ellipse, text width = 2cm, align = center] (2) at (1, 4) {Adviser};
\node [draw , ellipse, text width = 2cm, align = center] (3) at (-8, -5) {Course Concepts};
\node [draw , rectangle, text width = 4cm, align = center, text height = 1cm] (4) at (-3.5, -1) {\vspace{1cm} Programming Understanding \vspace{1cm}};
\node [draw , ellipse, text width = 2cm, align = center] (7) at (1, -5) {Independent Research};
\node [draw , ellipse, text width = 4cm, align = center] (8) at (-3.5, -7) {Peer \hspace{4cm} Collaborations};
