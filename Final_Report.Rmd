---
title: "Computational Knowledge Aquisition Strategies Among Environmental Science Graduate Students in a Methods of Data Analysis Course Sequence"
...
r <- ggplot(prereq, aes(x = Prereq, y = count, colour = Prereq, 
  ...
  labs(list(title = "Survey Participant Methods \nof Data Analysis I", x = "", 
...
\bibitem{compthinking}
Weintrop, D., Beheshti, E., Horn, M., Orton, K., Jona, K., Trouille, L., \& Wilensky, U. (2016). Defining Computational Thinking for Mathematics and Science Classrooms. Journal of Science Education Technology 25, 127-147. 
