---
title: Computational Knowledge Aquisition Strategies Among Environmental Science Graduate
  Students in a Methods of Data Analysis Course Sequence
...
1. What factors (attitude, background, course content, etc.) impact how graduate Environmental Science students gain computational knowledge and the ability to reason through computational applications in their disciplines?  
...
r <- ggplot(prereq, aes(x = Prereq, y = count, colour = Prereq, 
  ...
  labs(list(title = "Methods of Data Analysis I", x = "", 
...
s <- ggplot(cs_course, aes(x = CS_courses, y = count, colour = CS_courses, 
  ...
  theme(plot.title = element_text(size = rel(2), colour = "blue"), 
        axis.title.y = element_text(size = rel(1.2), colour = "black")) +
  labs(list(title = "Computer Science Courses", x = "", 
            y = ""))
...
t <- ggplot(languages, aes(x = Languages, y = count, colour = Languages, 
  ...
  geom_text(data = languages, aes(label = count,
                                y = count + 0.45), size = 6) + 
  scale_y_discrete("Number of Students", breaks = c(0, 1, 2, 3, 4), labels = c(0, 1, 2, 3, 4), 
                                           limits = c(0, 1, 2, 3, 4)) +
  theme(legend.background = element_rect(colour = "black"), 
        axis.text.x = element_blank()) +
  theme(plot.title = element_text(size = rel(2), colour = "blue"), 
        axis.title.y = element_text(size = rel(1.2), colour = "black"), 
        legend.justification = c(1, 1), legend.position = c(0.5955, 1)) +
  labs(list(title = "Computer Science Languages", x = "", 
            y = "Number of Students"))
...
u <- ggplot(stat_course, aes(x = Stat_courses, y = count, colour = Stat_courses, 
  ...
  theme(plot.title = element_text(size = rel(2), colour = "blue"), 
        axis.title.y = element_text(size = rel(1.2), colour = "black")) +
  labs(list(title = "Statistics Courses", x = "", 
            y = ""))
...
v <- ggplot(research, aes(x = Research_Amount, y = count, 
  ...
  theme(plot.title = element_text(size = rel(2), colour = "blue"),
        axis.title.y = element_text(size = rel(1.2), colour = "black"),
        legend.justification = c(1, 1), legend.position = c(0.65, 1)) +
  labs(list(title = "Independent Research", x = "", 
            y = "Number of Students"))
...
w <- ggplot(CS_interest, aes(x = CS_Interest, y = count, colour = CS_Interest, 
  ...
  theme(plot.title = element_text(size = rel(2), colour = "blue"), 
        axis.title.y = element_text(size = rel(1.2), colour = "black")) +
  labs(list(title = "CS Course Interest", x = "", 
            y = "Number of Students"))
...
x <- ggplot(Stat_Career, aes(x = Stat_Interest, y = count, 
  ...
  theme(plot.title = element_text(size = rel(2), colour = "blue"), 
        axis.title.y = element_text(size = rel(1.2), colour = "black")) +
  labs(list(title = "CS/Stat Career Interest", x = "", 
            y = "Number of Students"))

grid.arrange(r, s, nrow = 1)
grid.arrange(v, u, t, nrow = 2)
...
\node [draw , ellipse, text width = 4cm, align = center] (8) at (-3.5, -7) {Peer \hspace{4cm} Collaboration};
